...
export default function index() {
  return (
    <section id="home" className="max-[800px]:pt-[30px] pt-[80px] hero max-[800px]:h-full h-[100vh] text-white">
      <div className="container  max-[800px]:flex-col-reverse flex items-center max-[800px]:gap-[20px] gap-[50px] justify-between">
        <div>
          ...
          <h1 className="text-[46px] max-[450px]:text-[28px] max-[620px]:text-[32px] pt-[20px] font-semibold">
        ...
        <div className="pt-10 max-[800px]:pt-20">
          <div className="w-[400px] max-[800px]:w-[300px] max-[450px]:w-[250px] max-[450px]:h-[250px] h-[400px] max-[800px]:h-[300px]">
            <img
              className="w-full h-full rounded-full shadow-xl shadow-primary object-cover"
              src={People}
              alt="Sardor img"
            />
          </div>
